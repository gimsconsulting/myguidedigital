      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
          ...
          <div style="background: white; padding: 20px; border-radius: 8px; margin: 30px 0; border-left: 4px solid #667eea;">
            ...
            <p style="margin: 10px 0 0 0;">Profitez de <strong>30 jours d'essai gratuit</strong> pour découvrir toutes les fonctionnalités de la plateforme !</p>
          </div>
...
🎁 Offre spéciale : Profitez de 30 jours d'essai gratuit pour découvrir toutes les fonctionnalités de la plateforme !
