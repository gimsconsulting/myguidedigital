          ...
          {availableLanguages.length > 0 && (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white transition-colors"
              ...
              >
                ...
                <span className="text-sm font-medium">{availableLanguages.find(l => l.code === selectedLanguage)?.code.toUpperCase() || 'FR'}</span>
                <svg
