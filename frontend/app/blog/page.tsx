          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/" className="bg-gradient-to-r from-pink-300/50 to-rose-300/50 bg-clip-text text-transparent hover:from-pink-200 hover:to-rose-200 transition-all text-sm">Accueil</Link></li>
                <li><Link href="/hote-airbnb" className="bg-gradient-to-r from-pink-300/50 to-rose-300/50 bg-clip-text text-transparent hover:from-pink-200 hover:to-rose-200 transition-all text-sm">Nos services</Link></li>
                <li><Link href="/tarifs" className="bg-gradient-to-r from-pink-300/50 to-rose-300/50 bg-clip-text text-transparent hover:from-pink-200 hover:to-rose-200 transition-all text-sm">Nos tarifs</Link></li>
                <li><Link href="/blog" className="bg-gradient-to-r from-pink-300/50 to-rose-300/50 bg-clip-text text-transparent hover:from-pink-200 hover:to-rose-200 transition-all text-sm">Blog</Link></li>
                <li><Link href="/login" className="bg-gradient-to-r from-pink-300/50 to-rose-300/50 bg-clip-text text-transparent hover:from-pink-200 hover:to-rose-200 transition-all text-sm">Connexion</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/contact" className="bg-gradient-to-r from-pink-300/50 to-rose-300/50 bg-clip-text text-transparent hover:from-pink-200 hover:to-rose-200 transition-all text-sm">Contact</Link></li>
                ...
                <li><Link href="/affiliation" className="bg-gradient-to-r from-pink-300/50 to-rose-300/50 bg-clip-text text-transparent hover:from-pink-200 hover:to-rose-200 transition-all text-sm">Programme d&apos;affiliation</Link></li>
              </ul>
            </div>
          </div>
