        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/contact" className="bg-gradient-to-r from-pink-300/50 to-rose-300/50 bg-clip-text text-transparent hover:from-pink-200 hover:to-rose-200 transition-all text-sm">{t('home.footer.contact', 'Contact')}</Link></li>
